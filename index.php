    ...
    <div style="margin-inline: 10%; margin-block: 100px">
        <div class="row" style="display: flex; flex-direction:row">
            <div class="col-xs-12 col-md-6">
                <div class="about-img">
                    <img src="img/about.jpg" style="width: 100%;"  alt="" >
                </div>
            </div>    
            <div class="col-xs-12 col-md-6">
  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-md-6">
      <div class="menu-section">
        ...
        <hr/>
        <div class="menu-item">
          <div style="display: inline-block;" class="menu-item-name">Delicious Meal</div>
          <div style="display: inline-block; margin-left: 5%;" class="menu-item-price">$55</div>
          <div class="menu-item-description">Lorem ipsum dolor!</div>
        </div>
        <div class="menu-item">
        <div style="display: inline-block;" class="menu-item-name">Delicious Meal</div>
          <div style="display: inline-block; margin-left: 5%;" class="menu-item-price">$55</div>
